...
<div class="grid_12">
    ...
    <form class="normal-form" id="form-main" action="<?php echo $form_action ?>" method="post" autocomplete="off">
        ...
        <p>
            <label for="username">username</label><input type="text" id="Username" name="form_data[Username]" value="<?php echo $form_data['Username']; ?>" size="16" />
        </p>
        <p>
            <label for="password">password</label><input type="password" id="Password" name="form_data[Password]" value="<?php echo $form_data['Password']; ?>" size="16" />
        </p>
        <p>
        ...
        <p>
            <label for="StudentNumber">รหัสนักศึกษา</label><input type="text" id="StudentNumber" name="form_data[StudentNumber]" <?php echo $form_data['StudentNumber']; ?>/>
        </p>
